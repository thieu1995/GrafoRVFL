...
def fully_online_learning():
    """
    Fully online learning with RvflClassifier on Iris dataset.
    ...
    # Step 4: Define model
    model = RvflClassifier(size_hidden=10, act_name="elu", weight_initializer="random_uniform", reg_alpha=0, seed=42)
...
def hybrid_learning():
    """
    Hybrid learning with RvflClassifier on Iris dataset.
    ...
    # Step 3: Define model
    model = RvflClassifier(size_hidden=10, act_name="tanh", weight_initializer="random_normal", reg_alpha=0.001, seed=42)
