#!/usr/bin/env python
# Created by "Thieu" at 10:23, 03/04/2025 ----------%                                                                               
...
print(tuner.best_searcher.scores(data.X_test, data.y_test, list_metrics=("MSE", "RMSE", "MAPE", "NSE", "R2", "KGE")))

print(tuner.best_searcher.best_params)
print(tuner.best_searcher.best_estimator)
print(tuner.best_searcher.best_estimator.scores(data.X_test, data.y_test, list_metrics=("MSE", "RMSE", "MAPE", "NSE", "R2", "KGE")))
